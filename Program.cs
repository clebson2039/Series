...
namespace Dio.Sertes
{
    class Program
    {
        ...
        private static void AtualizarSere()
        {
            Console.Write("Digite o id da série: ");
             int indiceSerie = int.Parse (Console.ReadLine());
             ...
             Console.Write("Digite o gênero entres as duas opções acima: ");
             int entradaGenero = int.Parse(Console.ReadLine());

             Console.Write("Digite o Totulo da Série: ");
        ...
        private static string ObterOpcaoUsuario()
        {
            ...
            Console.WriteLine("Insorme a opção desejada: ");
